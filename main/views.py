...
def lfoffice(request):
    context = {
        'MEDIA_URL': settings.MEDIA_URL,
        'items_url': '/main/api/getLFOffices-2',
    }
...
def get_lfoffices_2(request):
    data = '''
    [
        { "id": "1", "location": "一餐一楼服务台", "remark": "11:30-12:30<br>17:30-18:30" },
        { "id": "2", "location": "二餐内餐卡办理处", "remark": "11:30-12:30<br>17:30-18:30" },
        { "id": "3", "location": "三餐一楼交大吃吃", "remark": "11:30-12:30<br>17:30-18:30" },
        { "id": "4", "location": "四餐一楼交大吃吃", "remark": "11:30-12:30<br>17:30-18:30" },
        { "id": "5", "location": "五餐二楼学生餐厅门口", "remark": "11:30-12:30<br>17:30-18:30" },
        { "id": "6", "location": "哈乐餐厅刷卡处", "remark": "10:30-19:00" },
        { "id": "7", "location": "东上二楼小卖部", "remark": "10:00-14:30" },
        ...
        { "id": "14", "location": "逸夫楼一楼值班处", "remark": "12:00-17:00<br>18:00-22:00" },
        ...
        { "id": "24", "location": "二餐外现金充值处", "remark": "工作日: 15:30-17:30<br>周末: 10:30-14:00" },
        { "id": "25", "location": "一餐外现金充值处", "remark": "工作日: 15:30-17:30<br>周末: 10:30-14:00" }
    ]'''
